...
import { useRouter } from 'next/router';  // keep useRouter if you need routing info for other reasons
...
export default function MobileNavigation({
    ...
    const { mobileNavRef, open } = useNavigationContext(); // removed currentLocale
    ...
    }, [routes]);  // trigger on routes changes
        ...
        >
            <div className={styles['c-mobileNav__inner']}>
                ...
                <div className={styles['c-mobileNav__footer']}>
                    ...
                    {/* Removed language switcher and its container */}
                </div>
            </div>
        </div>
    )
